...
public class Lpaging {
	...
	public Lpaging(int totalCount, int curPage) {
	...
	public Lpaging(int totalCount) {
		setTotalCount(totalCount);
		
		makePaging();
	}
	
	public Lpaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public Lpaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);	//화면에 보여질 게시글 개수 지정하기
