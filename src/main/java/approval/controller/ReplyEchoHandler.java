   ...
   protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
      ...
      if(StringUtils.hasText(msg)) {
         ...
         if(strs != null && strs.length == 5) {
            ...
            } else if("cmt".equals(cmd) && appWriterSession != null) {
               TextMessage tmpMsg = new TextMessage(replyWriter +" 님이 <a href=/board/boardView?bno=" + approvalNo +">" +apptitle+"</a> 에 댓글을 작성 하셨습니다");
