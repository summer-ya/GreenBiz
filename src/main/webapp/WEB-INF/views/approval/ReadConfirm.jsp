         ...
         <div class="main_section">
            ...
            <table  style="width: 100%; position: absolute; top: 47%; "  class="board-listheader" >
               <tr>
                   ...
                   <td>기안자</td>
                   <td colspan="2"><input type="text" disabled="disabled" value="${appconfirm.memberNo }" style="width: 95%; background:white; border: none; text-align: center;">
                   </td>
                   <td>기안일시</td>
...
// 			$(function(){
// 				if(){
// 					document.getElementById("appopen").style.display = "";
// 				} else {
// 				document.getElementById("appopen").style.display = "none";
// 				}
// 			})
         ...
         <div class="apwrite" id="appopen" style="position: absolute; top: 92%; right: -4%;">
            ...
            <button type="button" id="new_pj_btn" class="btn btn-primary" onclick="newpjModal">결재요청</button>
